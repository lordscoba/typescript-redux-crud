...
import { userCreateAction } from "../redux/actions/user_actions";
...
const Create = (props: Props) => {
  ...
  let {
    ...
    error: userError,
  } = useSelector((store: any) => store.userCreate);

  const handleSubmit = (e: any) => {
    e.preventDefault();
    if (name && username && email) {
      dispatch(userCreateAction({ name, username, email }) as any);
    }
  };
  ...
  return (
    <section>
      <div className="flex flex-col mt-24">
        ...
        <h1 className="mx-auto text-2xl mb-5 hover:text-4xl">Create User</h1>
